module.exports.CssSelector = (function () {
...
class Resizable{
    ...
    init(){
        this.resizeHandler = this.newResizeHandler();
        this.elem.appendChild(this.resizeHandler);
        this.elem.classList.add('resizable');
    }

    newResizeHandler(){
        let handler = document.createElement('div');
        handler.style.backgroundImage = 'url(resources/media/resize.png)';
        handler.className = "resizer";
        handler.onmousedown = (e)=> this.initResize(e);
        return handler;
    }
    ...
    initResize(e){
        ...
        this.startHeight = parseInt(document.defaultView.getComputedStyle(this.elem).height, 10);
        document.documentElement.onmousemove = (e)=>this.resize(e);
        document.documentElement.onmouseup = (e)=>this.stop(e);
    }
    ...
    resize(e){
        ...
        this.elem.style.width = (this.startWidth + e.clientX - this.resizeHandlerX) + 'px';
        this.elem.style.height = (this.startHeight + e.clientY - this.resizeHandlerY) + 'px';
...
class Draggable{
    ...
    init(){
        ...
        this.elem.onmouseup = (e)=>this.stopDrag(e);
